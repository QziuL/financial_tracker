...
class _SummaryChartState extends State<SummaryChart>
  ...
  void initState() {
    ...
    _rotateAnim = CurvedAnimation(parent: _controller, curve: Curves.easeOutCubic);
    _controller.forward();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: (widget.totalIncome == 0 && widget.totalExpense == 0)
                    ...
                    child: Column(
                      ...
                      children: [
                        _buildLegend(
                          ...
                          percent: total > 0 ? (widget.totalIncome / total * 100) : 0,
                        ...
                        _buildLegend(
                          ...
                          percent: total > 0 ? (widget.totalExpense / total * 100) : 0,
